        ...
        if (type == 'image') {
            ...
            if ($(input).hasClass('main-audio')) {
                ...
                if (enableFeaturing) {
                    ...
                    featuringDiv = "<div class='featuring-container hide'><hr/>" +
                ...
                if (enableLyrics) {
                    ...
                    lyricsDiv = $("<div class='lyrics-input-container hide' >" +
                        "<hr/><div style='padding:0 10px;'><label>"+strings.add_lyrics+"</label>" +
                ...
                data.append("<div class='middle clearfix' style='margin: 0 10px'>" +
                    ...
                    "</div>" +
                    "<div style='padding:5px 10px'><small class='ml-1'><a style='background: #fff !important;border-color: #F1F1F1 !important;color: #000;' href='' class='btn btn-sm round-sm  btn-outline-secondary' onclick='return toggle_custom_url_field(this)'>"+strings.custom_url+"</a> "+addPrice+" "+featuringBtn+" "+lyricsBtn+" </small></div>" +
                    "");
                ...
                data.append("<div class='custom-url-container hide'><hr/>" +
                    ...
                    "</div>" +
                    "</div>");
                data.append(featuringDiv);
                data.append(lyricsDiv);
                if ($(".upload-pricing").length > 0) {
...
function reloadInit(paginate) {
    ...
    $('.input-tags').each(function() {
        ...
        if ($(this).data('popup') !== undefined) {
            options = {
                plugins: ['remove_button','drag_drop', 'dropup'],
            }
        }
    ...
    $("#music-player").jPlayer({
        ...
        timeupdate : function(event) {
            ...
            if (window.playerLyrics != null) {
                percent = _rn(event.jPlayer.status.currentPercentRelative, 1)
